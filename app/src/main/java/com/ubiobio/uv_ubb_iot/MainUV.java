...
public class MainUV extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_uv);

        Button btnUpdate = findViewById(R.id.btnActualizar);
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                actualizar( UV_SENSOR);
    ...
    private void actualizarChart() {
        ...
        int seriesIndexValor = decoView.addSeries(
                new SeriesItem.Builder(getResources().getColor(R.color.Yellow),
